...
[Project on my blog](https://jet-w.github.io/unisa/2023SP5/AdvancedAnalyticTechniques2/project.html) \>Password: #Thuc
...
```{r message=FALSE, warning=FALSE}
data <- read_csv(
  "https://jet-w.github.io/data/unisa/AdvancedAnalytic2/project/BRCA_RNASeqv2_top50.csv", 
  col_names = TRUE
)
