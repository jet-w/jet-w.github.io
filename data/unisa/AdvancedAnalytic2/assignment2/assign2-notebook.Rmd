...
The [online shopping recommendation system]{style="color:orange"}, such as JD recommendation system (A Chinese online shop), could use topic modelling to work. The key work is to calculate the similarity. All the works could be processed with three steps.
...
[QGIS: An Introduction to an Open-Source Geographic Information System](https://extension.msstate.edu/publications/qgis-introduction-open-source-geographic-information-system)
