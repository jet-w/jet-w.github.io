...
import 'piccolore';
import { $ as $$BaseLayout } from './BaseLayout.CiEY8HDX.js';
import { s as siteConfig } from './site.BotSC3KX.js';
...
import { g as getCollection } from './astro_content.jtvWDo3g.js';
...
}, "/home/runner/work/jet-w.blog/jet-w.blog/modules/astro_blog/src/components/layout/Header.astro", void 0);
...
}, "/home/runner/work/jet-w.blog/jet-w.blog/modules/astro_blog/src/components/layout/Footer.astro", void 0);
...
}, "/home/runner/work/jet-w.blog/jet-w.blog/modules/astro_blog/src/components/ui/Icon.astro", void 0);
...
文章归档
</h3> <div class="space-y-2" data-astro-cid-k4cmclh2> ${archives.map((archive) => renderTemplate`<a${addAttribute(`/archives/${archive.year}/${archive.month}`, "href")} class="flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group" data-astro-cid-k4cmclh2> <span class="text-sm text-slate-700 dark:text-slate-300 group-hover:text-primary-500" data-astro-cid-k4cmclh2> ${archive.year}年${archive.month}月
</span> <span class="text-xs text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded-full" data-astro-cid-k4cmclh2> ${archive.count} </span> </a>`)} </div> </section>`}  ${sidebarConfig.showFriendLinks} </div>  ${renderScript($$result, "/home/runner/work/jet-w.blog/jet-w.blog/modules/astro_blog/src/components/layout/Sidebar.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/runner/work/jet-w.blog/jet-w.blog/modules/astro_blog/src/components/layout/Sidebar.astro", void 0);
